...
/*   Updated: 2026/01/10 17:23:12 by rbourdon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_after_rbracket(t_token *tok, t_token_type prev)
{
...
static int ft_in_checker(t_token *tok, t_token_type prev)
{
	...
	else if (prev == TOKEN_LBRACKET)
		return (ft_first_tok_checker(tok));
	else if (prev == TOKEN_RBRACKET)
		return (ft_after_rbracket(tok, prev));
	return (1);
}
